...
class HomeViewController: UIViewController {
    ...
    private func configureCollectionView() {
        ...
        collectionView.register(NewReleaseCollectionViewCell.self, forCellWithReuseIdentifier: "NewReleaseCollectionViewCell")
        collectionView.register(FeaturedCollectionViewCell.self, forCellWithReuseIdentifier: "FeaturedCollectionViewCell")
        collectionView.register(RecommendedTrackCollectionViewCell.self, forCellWithReuseIdentifier: "RecommendedTrackCollectionViewCell")
    ...
    private func configureModels(newAlbums: [Album], playlists: [Playlist], tracks: [AudioTrack]) {
        ...
        self.tracks = tracks
        sections.append(.newReleases(viewModels: newAlbums.compactMap({ return NewReleasesCellViewModel(name: $0.name, artworkURL: URL(string: $0.images.first?.url ?? ""), numberOfTracks: $0.total_tracks, artistName: $0.artists.first?.name ?? "")})))
...
extension HomeViewController: UICollectionViewDataSource {
    ...
    static func createSectionLayout(section: Int) -> NSCollectionLayoutSection {
        ...
        default:
            // Item
            let item = NSCollectionLayoutItem(layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .absolute(190)))
